...
extern int ws_read_data(int fd, uint16_t addr, size_t len, uint8_t *buf);
extern int ws_read_safe(int fd, uint16_t addr, size_t len, uint8_t *buf);
extern int ws_read_batch(int fd, const uint16_t *addr, const size_t *len, size_t sz, uint8_t *buf);
